...
describe('AppComponent', () => {
  ...
  it(`should have as title 'declinator'`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    expect(app.title).toEqual('declinator');
  });
  ...
  it('should render title', () => {
    ...
    expect(compiled.querySelector('.content span').textContent).toContain('declinator app is running!');
  });
});
